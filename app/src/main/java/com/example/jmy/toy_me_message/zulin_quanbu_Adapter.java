...
public class zulin_quanbu_Adapter extends BaseAdapter {
    private List<Map<String, Object>> data;
    private LayoutInflater layoutInflater;
    private Context context;

    public zulin_quanbu_Adapter(Context context, List<Map<String, Object>> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        // TODO Auto-generated method stub
        zulin_quanbu_Adapter.Info info = new zulin_quanbu_Adapter.Info();
        convertView = layoutInflater.inflate(R.layout.zulin_quanbu_item, null);
