...
public class goumai_daishou_Adapter extends BaseAdapter {
    private List<Map<String, Object>> data;
    private LayoutInflater layoutInflater;
    private Context context;

    public goumai_daishou_Adapter(Context context, List<Map<String, Object>> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        // TODO Auto-generated method stub
        goumai_daishou_Adapter.Info info = new goumai_daishou_Adapter.Info();
        convertView = layoutInflater.inflate(R.layout.goumai_daishou_item, null);
