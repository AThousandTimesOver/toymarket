...
public class zulin_weifu_Adapter extends BaseAdapter {
    private List<Map<String, Object>> data;
    private LayoutInflater layoutInflater;
    private Context context;

    public zulin_weifu_Adapter(Context context, List<Map<String, Object>> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        // TODO Auto-generated method stub
        zulin_weifu_Adapter.Info info = new zulin_weifu_Adapter.Info();
        convertView = layoutInflater.inflate(R.layout.zulin_weifu_item, null);
