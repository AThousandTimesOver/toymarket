...
public class zulin_daishou_Adapter extends BaseAdapter {
    private List<Map<String, Object>> data;
    private LayoutInflater layoutInflater;
    private Context context;

    public zulin_daishou_Adapter(Context context, List<Map<String, Object>> data) {
    ...
    public class Info {
        ...
        public TextView tv_zulinshichang;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        // TODO Auto-generated method stub
        zulin_daishou_Adapter.Info info = new zulin_daishou_Adapter.Info();
        convertView = layoutInflater.inflate(R.layout.zulin_daishou_item, null);
        ...
        info.tv_zulinshichang = (TextView) convertView
                .findViewById(R.id.textView_zulinshichang);
        ...
        info.tv_zongjiage.setText((String) data.get(position)
                .get("zongjiage"));
        info.tv_zulinshichang.setText((String) data.get(position)
                .get("zulinshichang"));
        return convertView;
    }
}
