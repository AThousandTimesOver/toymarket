...
public class zulin_yifu_Adapter extends BaseAdapter {
    private List<Map<String, Object>> data;
    private LayoutInflater layoutInflater;
    private Context context;

    public zulin_yifu_Adapter(Context context, List<Map<String, Object>> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        // TODO Auto-generated method stub
        zulin_yifu_Adapter.Info info = new zulin_yifu_Adapter.Info();
        convertView = layoutInflater.inflate(R.layout.zulin_yifu_item, null);
