...
public class me_dingdan_goumai extends AppCompatActivity implements View.OnClickListener{
    ...
    private FourthFragment fouthFragmen;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_me_dingdan_goumai);
    ...
    private void initViews() {
        ...
        fouthFragmen = new FourthFragment();
        //给FragmentList添加数据
