...
public class zulin_fanhuan_Adapter extends BaseAdapter {
    private List<Map<String, Object>> data;
    private LayoutInflater layoutInflater;
    private Context context;

    public zulin_fanhuan_Adapter(Context context, List<Map<String, Object>> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        // TODO Auto-generated method stub
        zulin_fanhuan_Adapter.Info info = new zulin_fanhuan_Adapter.Info();
        convertView = layoutInflater.inflate(R.layout.zulin_fanhuan_item, null);
